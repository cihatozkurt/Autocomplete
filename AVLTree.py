...
class AVLTree:
    ...
    def find_most_likely_ngrams(self, word: str):
        ...
        :return: Ein heap mit den möglichen Fortsetzungen,
        ...
        def traverse(node):
            ...
            # Wenn der Schlüssel des Knotens mit dem Präfix beginnt
            if node.key.startswith(word):
                # Füge das Element negierter Frequenz hinzu, um einen Max-Heap zu simulieren
                heapq.heappush(heap, (-node.get_value()[0], node.key))
        ...
        # Starte die Traversierung am Wurzelknoten
        traverse(self.root)

        return heap, searched_nodes
